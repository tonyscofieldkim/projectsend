...
/**
 * Security Issue: Handle XSS. Leaving all fields as they are in the database. [Fixed] ✔️
 */
global $dbh;
...
if (!empty($options_values)) {
	...
	define('THIS_INSTALL_SET_TITLE', htmlspecialchars($options_values['this_install_title'], ENT_QUOTES, 'UTF-8', false));
	...
	if (isset($options_values['admin_email_address'])) {
		define('ADMIN_EMAIL_ADDRESS', htmlspecialchars($options_values['admin_email_address'], ENT_QUOTES, 'UTF-8', false));
	}
	/**
	...
	if (isset($options_values['email_new_file_by_user_customize'])) {
		/** Checkboxes */
		define('EMAILS_FILE_BY_USER_USE_CUSTOM', htmlspecialchars($options_values['email_new_file_by_user_customize'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_FILE_BY_CLIENT_USE_CUSTOM', htmlspecialchars($options_values['email_new_file_by_client_customize'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_CLIENT_BY_USER_USE_CUSTOM', htmlspecialchars($options_values['email_new_client_by_user_customize'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_CLIENT_BY_SELF_USE_CUSTOM', htmlspecialchars($options_values['email_new_client_by_self_customize'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_NEW_USER_USE_CUSTOM', htmlspecialchars($options_values['email_new_user_customize'], ENT_QUOTES, 'UTF-8', false));

		/** Texts */
		define('EMAILS_FILE_BY_USER_TEXT', htmlspecialchars($options_values['email_new_file_by_user_text'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_FILE_BY_CLIENT_TEXT', htmlspecialchars($options_values['email_new_file_by_client_text'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_CLIENT_BY_USER_TEXT', htmlspecialchars($options_values['email_new_client_by_user_text'], ENT_QUOTES, 'UTF-8', false));
	...
	if (isset($options_values['email_header_footer_customize'])) {
		/** Checkbox */
		define('EMAILS_HEADER_FOOTER_CUSTOM', htmlspecialchars($options_values['email_header_footer_customize'], ENT_QUOTES, 'UTF-8', false));
		/** Texts */
		define('EMAILS_HEADER_TEXT', htmlspecialchars($options_values['email_header_text'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_FOOTER_TEXT', htmlspecialchars($options_values['email_footer_text'], ENT_QUOTES, 'UTF-8', false));
	}
	...
	if (isset($options_values['email_pass_reset_customize'])) {
		/** Checkbox */
		define('EMAILS_PASS_RESET_USE_CUSTOM', htmlspecialchars($options_values['email_pass_reset_customize'], ENT_QUOTES, 'UTF-8', false));
		/** Text */
		define('EMAILS_PASS_RESET_TEXT', htmlspecialchars($options_values['email_pass_reset_text'], ENT_QUOTES, 'UTF-8', false));
	}
	...
	if (isset($options_values['saml2_sso_only'])) {
		...
		define('SAML2_ATTR_FIRSTNAME', $options_values['saml2_assert_attr_firstname']);
		define('SAML2_ATTR_LASTNAME', $options_values['saml2_assert_attr_lastname']);
	...
	if (isset($options_values['footer_custom_enable'])) {
		...
		define('FOOTER_CUSTOM_CONTENT', htmlspecialchars($options_values['footer_custom_content'], ENT_QUOTES, 'UTF-8', false));
	}
	...
	if (isset($options_values['email_new_file_by_user_subject'])) {
		...
		/** Subjects */
		define('EMAILS_FILE_BY_USER_SUBJECT', htmlspecialchars($options_values['email_new_file_by_user_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_FILE_BY_CLIENT_SUBJECT', htmlspecialchars($options_values['email_new_file_by_client_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_CLIENT_BY_USER_SUBJECT', htmlspecialchars($options_values['email_new_client_by_user_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_CLIENT_BY_SELF_SUBJECT', htmlspecialchars($options_values['email_new_client_by_self_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_NEW_USER_SUBJECT', htmlspecialchars($options_values['email_new_user_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_PASS_RESET_SUBJECT', htmlspecialchars($options_values['email_pass_reset_subject'], ENT_QUOTES, 'UTF-8', false));
	}
	...
	if (isset($options_values['email_account_approve_subject'])) {
		...
		/** Subjects */
		define('EMAILS_ACCOUNT_APPROVE_SUBJECT', htmlspecialchars($options_values['email_account_approve_subject'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_ACCOUNT_DENY_SUBJECT', htmlspecialchars($options_values['email_account_deny_subject'], ENT_QUOTES, 'UTF-8', false));
		/** Email texts */
		define('EMAILS_ACCOUNT_APPROVE_TEXT', htmlspecialchars($options_values['email_account_approve_text'], ENT_QUOTES, 'UTF-8', false));
		define('EMAILS_ACCOUNT_DENY_TEXT', htmlspecialchars($options_values['email_account_deny_text'], ENT_QUOTES, 'UTF-8', false));
	}
	...
	if (isset($options_values['email_client_edited_subject_customize'])) {
		...
		/** Subject */
		define('EMAILS_CLIENT_EDITED_SUBJECT', htmlspecialchars($options_values['email_client_edited_subject'], ENT_QUOTES, 'UTF-8', false));
		/** Text */
		define('EMAILS_CLIENT_EDITED_TEXT', htmlspecialchars($options_values['email_client_edited_text'], ENT_QUOTES, 'UTF-8', false));
	}
