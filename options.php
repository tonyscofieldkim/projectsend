				...
				$(document).ready(function() {
					...
					$("form").submit(function() {
						...
						if (show_form_errors() == false) {
							alert('<?php _e('Please complete all the fields.', 'cftp_admin'); ?>');
							return false;
						}
					});
				});
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" name="clients_can_select_group" id="clients_can_select_group">
									...
									?>
										<option value="<?php echo $value; ?>" <?php if (CLIENTS_CAN_SELECT_GROUP == $value) {
																					echo 'selected="selected"';
					...
					?>
						...
						<div class="options_column">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<span class="format_url"><?php echo BASE_URI . 'sso/pingfed/slo2.php?finish'; ?></span>
								</div>
							</div>
							<div class="form-group">
